...
| Manifest/MCP/web policy | `project.example.toml`, `templates/research-repo/project.toml` | Manifests, `scripts/doctor.ps1`, research `AGENTS.md` | `scripts/doctor.ps1 -Json -Deep`, targeted doctor smoke tests |
